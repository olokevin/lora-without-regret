...
# CUDA_VISIBLE_DEVICES=2 bash bash_scripts/eval_commonsense.sh base_model=meta-llama/Meta-Llama-3-8B CKPT=/data/yequan/fura/lift/commonsense/meta-llama/Meta-Llama-3-8B/blocktt-calib_v2_bp-lr_2e-5-decomp_output_one_block_pos_small_smerge_keep_trainable-seed_43 >/dev/null 2>&1 &
